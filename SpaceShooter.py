...
pygame.display.set_caption("Space Hos")
...
class Player(Ship):
    ...
    def healthbar(self, window):
        ...
        pygame.draw.rect(window, (0, 255, 0),
                         (self.x, self.y + self.player_img.get_height() + 10, self.player_img.get_width() * (1 - (self.max_health - self.health)/self.max_health), 10))
...
def main_menu():
    ...
    while run:
        WIN.blit(BG, (0,0))
        title_label = title_font.render("Click The Mouse Bitch!", 1, (255,255,255))
